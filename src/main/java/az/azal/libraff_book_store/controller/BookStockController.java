...
public class BookStockController {
	...
	public ResponseEntity<String> restockBook(@RequestBody TransactionRestockRequest request) {
		...
		return new ResponseEntity<String>("Successfully restocked books!", HttpStatus.OK);

	}

	protected ResponseEntity<String> restockBookFallback(TransactionRestockRequest request, Throwable t) {
